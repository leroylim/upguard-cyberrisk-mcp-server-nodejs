/**
 * UpGuard CyberRisk MCP Server - Master Setup Script
 * 
...
class ProjectSetupManager {
  ...
  async runSetup(options = {}) {
    ...
    console.log('🚀 Starting UpGuard CyberRisk MCP Server Enhanced Setup...\n');
  ...
  async createProjectOverview() {
    const overview = `# 🚀 UpGuard CyberRisk MCP Server - Enhanced Project Overview
...
---
**Generated by UpGuard CyberRisk MCP Server Enhanced Setup v1.2.0**
`;
